...
lTemp = (((lTemp And &HFFFFFF00) \ &H100) And &HFFFFFF) Xor (m_CRC32Table((lTemp And 255) Xor bArrayIn(lCurPos)))
Next lCurPos
...
End Function
'Private Function
Public Function CalculateBytes(ByVal Arr As Long, ByVal Size As Long) As Long
    Dim CRC32 As Long
    ...
    Call CallWindowProc(VarPtr(m_CRC32Asmbl(0)), VarPtr(CRC32), Arr, VarPtr(m_CRC32Table(0)), Size)
