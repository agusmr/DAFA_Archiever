...
Begin VB.Form FrmUtama 
   ...
   Begin DAFA_Component.c c 
      ...
      FileFlags       =   2621444
      FolderFlags     =   323
      FileCustomFilter=   "FrmUtama.frx":1555E
      FileDefaultExtension=   "FrmUtama.frx":1557E
      FileFilter      =   "FrmUtama.frx":1559E
      FileOpenTitle   =   "FrmUtama.frx":155E6
      FileSaveTitle   =   "FrmUtama.frx":1561E
      FolderMessage   =   "FrmUtama.frx":15656
   End
    ...
    Loop
            ...
            If JumSelect > 0 Then
                For i = 1 To JumSelect
                    If ApakahFile = True Then
                        ExtractFile Alamat, JumSelect, y
                        Tempat = y & AmbilNama(LVSelect.ListItems(i).Text)
                        data.Files.Add Tempat
                    Else
                        ExtractSingleFol Alamat, CariSelect, y
                        Tempat = y & CariSelect
                        data.Files.Add Tempat
                    End If
                Next i
