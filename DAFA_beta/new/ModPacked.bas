...
Exx:
    ...
    BacaArchive Simpan
Ex:
Call ShowErroR(BuatArchive, PesanError)
End Function
Public Function BuatHeader(Hnd As Long, Offset As Long, ByVal nama As String) As Boolean
    ...
    Hnd = CreateFileW(StrPtr(nama), &H40000000, &H2, ByVal 0&, 2, 0, 0)
        ...
        End If
Ex:
    Call ShowErroR(BuatHeader, PesanError)
End Function
...
Ex:
    Call ShowErroR(TulisFile, PesanError)
End Function
Public Function BacaArchive(ByVal AlamatNya As String) As Boolean
    ...
    '// buka file archive dulu
        ...
        If Not DapatkanHeader(AlamatNya, hFileR, MySize, Pointer) Then
            BacaArchive = False
            pesanE = pesanE & "Gagal membuka archive " & StripNulls(AlamatNya) & " !" & vbCrLf
            GoTo Ex
        End If
        ...
        If Pointer > MySize Or ErrorHard Then
            BacaArchive = False
            GoTo Exx
        ElseIf Pointer = MySize Then
            BacaArchive = False
            pesanE = pesanE & "File Archive kosong !" & vbCrLf
...
Ex:
On Error Resume Next
    Call ShowErroR(BacaArchive, PesanError)
        With FrmUtama
...
loncat:
    Call VbCloseHandle(hFileR)
Ex:
    Call ShowErroR(BacaFile, PesanError)
End Function
...
Public Function ExtractSingleFol(ByVal AlamatNya As String, ByVal NameFolder As String, ByVal Simpan As String) As Long
    ...
    Do
        ...
        If pos > 0 Then
            Slash = Mid(DAT, pos - 1, 1)
        End If
        If pos > 0 And Slash <> "\" Then
...
Public Function TambahArchive(ByVal Alamat As String, ByVal jumlah As Long) As Boolean
    ...
    '// buka file archive dulu
        ...
        If Header.flags And FLock Then
            ...
            TambahArchive = False
            Call ShowErroR(TambahArchive, PesanError)
            GoTo Ex
        End If
...
Back:
    Call ShowErroR(DapatkanInfo, PesanError)
Exit Function
Exx:
    DapatkanInfo = False
    GoTo Back
...
Exx:
        ...
        Call ShowErroR(CekHeader, PesanError)
End Function
Public Sub ShowErroR(ByVal Valid As Boolean, ByVal pesan As String)
    If Not Valid Then
        FrmDiagnosa.TPesan.Text = pesan
        FrmDiagnosa.Show 1
...
Public Function CekCheksum(ByVal Nilai1 As Long, ByVal Nilai2 As Long) As Boolean
    ...
    If Nilai1 <> Nilai2 Then
        ...
        CekCheksum = False
        Call ShowErroR(CekCheksum, PesanError)
    Else
        CekCheksum = True
    End If
End Function
Public Function CekCheksumK(ByVal Nilai1 As Long, ByVal Nilai2 As Long, ByVal nama As String) As Boolean
    ...
    If Nilai1 <> Nilai2 Then
        ...
        CekCheksumK = False
        Call ShowErroR(CekCheksumK, PesanError)
    Else
        CekCheksumK = True
    End If
End Function
